...
const Restaurants = ({restaurantList, updateRev, changeStatus, deleteCard, edit, editActionCreator}) => { 
  ...
  if (restaurantList.review !== '' && edit === false) {
    editButton.push(<button className="editButton" onClick={editClick}>Edit</button>)
  }
  ...
  if (restaurantList.status === 'not visited') {
    recommendation.push(
    <button className="thumbs" onClick={recommended}>
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="rgb(197, 197, 197)" className="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
    ...
    <button className="thumbs2" onClick={notRecommended}>
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="rgb(197, 197, 197)" className="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
